...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_managerwindow_t, stringdata0) + ofs), len 
...
const QMetaObject managerwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_managerwindow.offsetsAndSize,
    qt_meta_data_managerwindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_managerwindow_t
