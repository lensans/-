...
public:
    ...
    QPushButton *btn_subject_relation;
    QPushButton *btn_single_score;
    QLabel *interface_1;
...
""));
        ...
        btn_subject_relation = new QPushButton(widget);
        btn_subject_relation->setObjectName(QString::fromUtf8("btn_subject_relation"));
        btn_subject_relation->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 219, 255);\n"
"color: rgb(0,0,0);\n"
"\n"
"border:0px groove gray;border-radius:\n"
"7px;padding:2px 4px;\n"
...
""));
        ...
        verticalLayout->addWidget(btn_subject_relation);

        btn_single_score = new QPushButton(widget);
        btn_single_score->setObjectName(QString::fromUtf8("btn_single_score"));
        btn_single_score->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 219, 255);\n"
"color: rgb(0,0,0);\n"
"\n"
"border:0px groove gray;border-radius:\n"
"7px;padding:2px 4px;\n"
...
""));
        ...
        verticalLayout->addWidget(btn_single_score);
    ...
    void retranslateUi(QMainWindow *managerwindow)
    {
        ...
        btn_subject_relation->setText(QCoreApplication::translate("managerwindow", "\350\257\255\346\225\260\345\244\226\345\222\214\347\220\206\345\214\226\347\224\237\345\205\263\347\263\273", nullptr));
        btn_single_score->setText(QCoreApplication::translate("managerwindow", "\345\261\225\347\244\272\345\215\225\347\247\221\346\210\220\347\273\251\347\233\264\346\226\271\345\233\276", nullptr));
